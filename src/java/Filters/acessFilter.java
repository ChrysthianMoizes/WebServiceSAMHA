...
public class acessFilter implements Filter {
        ...
        try {
            ...
            if(token != null){
                ...
                if(result. equals("Token valido"))
                    ...
                    if(UserControl.validateLogin(email, password)){
                        JSONObject newJsonToken = AcessTokenControl.newToken(email);
    ...
    private void cadastro(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String result = UserControl.cadastrarNovoUsuario(name, email, password);
